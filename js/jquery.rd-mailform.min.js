...
!(function (e) {
  function t(o, s, n) {
    (i = e.extend(!0, {}, i, n)),
      (this.options = e.extend(!0, {}, t.Defaults, s)),
      (this.$element = e(o)),
      (this._plugins = {}),
      (this._handlers = {
  ...
  (i = {
    ...
    (e.fn.rdMailForm = function (i, o) {
      return this.each(function () {
        e(this).data("rdMailForm") ||
          e(this).data("rdMailForm", new t(this, i, o));
      });
    }),
  ...
  (function (e) {
    var t = (e.fn.rdMailForm.Constructor.Plugins.Validator = function (i) {
      (this._core = i),
        ...
        (this._core.options = e.extend(!0, {}, t.Defaults, this._core.options)),
        this.initialize();
    });
    (t.Defaults = {
      validator: {
          ...
          "@Date": {
            rule: function (e) {
              return navigator.userAgent.match(/(iPod|iPhone|iPad)/)
                ? !0
                : new RegExp(
                    "^($)|(((0[13578]|10|12)(-|\\.)((0[1-9])|([12])([0-9])|(3[01]?))(-|\\.)((19)([2-9])(\\d{1})|(20)([01])(\\d{1})|([8901])(\\d{1}))|(0?[2469]|11)(-|/)(([1-9])|(0[1-9])|([12])([0-9]?)|(3[0]?))(-|/)((19)([2-9])(\\d{1})|(20)([01])(\\d{1})|([8901])(\\d{1}))))$"
                  ).test(e.val());
            },
        ...
        this._core.$element
          ...
          .each(function () {
            e(this)
              .parent()
              .append(
                e("<span/>", { class: t._core.options.validator["class"] })
              );
          });
      }),
      (t.prototype.watch = function () {
        ...
        this._core.$element
          .find(this._core.options.validator.applyTo)
          .on("keyup", function () {
            (e(this).is("input") || e(this).is("textarea")) &&
              e(this).parent().find(".mfValidation").hasClass("error") &&
              e(this)
                .parent()
                .trigger("mfValidator.validate", {
          ...
          .on("click", function () {
            e(this)
              ...
              .find(t._core.options.validator.applyTo)
              .focus();
          }),
          this._core.$element
            .on(
              ...
              e.proxy(function (i) {
                return (
                  ...
                  this._core.$element.find(".error").length
                    ? (i.preventDefault(), !1)
                    : void 0
                );
              }, this)
      ...
      (t.prototype.validate = function (t, i) {
        var o,
          ...
          c = r.val();
        for (var d in l)
          if (i.options.constraints[l[d]]) {
            switch (typeof i.options.constraints[l[d]].rule) {
              case "function":
                i.options.constraints[l[d]].rule(r)
                  ? a.find(".mfValidation") &&
                    a.find(".mfValidation").attr("data-index") === d &&
                    ((o = !0), a.find(".mfValidation").attr("data-index", -1))
                  : (s.push(i.options.constraints[l[d]].message),
                    n.push(d),
                    (o = !0));
                break;
              default:
                new RegExp(i.options.constraints[l[d]].rule).test(c)
                  ? a.find(".mfValidation").attr("data-index") &&
                    a.find(".mfValidation").attr("data-index") == d &&
                    ((o = !0), a.find(".mfValidation").attr("data-index", -1))
                  : (s.push(i.options.constraints[l[d]].message),
                    n.push(d),
        ...
        s.length
          ? e(this).trigger("mfValidator.error", {
              options: i.options,
              errors: s,
              indexes: n,
            })
      ...
      (t.prototype.error = function (t, i) {
        e(this)
          .find("." + i.options["class"])
          .removeClass("valid")
          .removeClass("hide")
          .addClass("show")
          .addClass("error")
          .attr("data-index", i.indexes[0])
          .text(i.errors);
      }),
      (t.prototype.valid = function (t, i) {
        var o = e(this).find("." + i.options["class"]);
        o.hasClass("error") && o.removeClass("error").addClass("hide"),
          o
            .find("." + i.options["class"])
            .removeClass("show")
            .addClass("valid")
      ...
      (t.prototype.watch = function () {
        this._core.$element
          ...
          .on("keydown", this, function (t) {
            t.data.ignore(t) ||
              ((8 === t.keyCode || 46 === t.keyCode) &&
                e(this).parent().trigger("mfInput.delete"),
              (32 === t.keyCode || t.keyCode > 46) &&
                e(this).parent().trigger("mfInput.type"));
          })
          .on("keyup", this, function (t) {
            var i = e(this);
            t.data.ignore(t) ||
              ("" === i.val() && i.parent().trigger("mfInput.empty"),
              8 === t.keyCode || 46 === t.keyCode
                ? (self.timer && clearTimeout(self.timer),
                  (self.timer = setTimeout(function () {
                    i.parent().trigger("mfInput.idle");
                  }, 1e3)))
                : (i.parent().trigger("mfInput.fill"),
          ...
          this._core.$element.on("mf.reset", this, function (t) {
            e(this)
              .find("." + t.data._core.options.input["class"])
              .each(function () {
  ...
  (function (e) {
    ...
    (t.Defaults = { select: { applyTo: "select", class: "mfSelect" } }),
      (t.prototype.initialize = function () {
      ...
      (t.prototype.watch = function () {
        var t = this;
        this._core.$element
          .find(t._core.options.select.applyTo)
          .on("focus", this.focus)
          .on("blur", function () {
              ...
              e(this)
                .val(
                  e(this)
                    .find("option")
                    .eq(
                      e(this).find("option:selected").index() > 0
                        ? e(this).find("option:selected").index() - 1
                        : 0
                    )
                    .text()
                )
                ...
                e(this)
                  .val(
                    e(this)
                      .find("option")
                      .eq(
                        e(this).find("option:selected").index() <
                          e(this).find("option").length - 1
                          ? e(this).find("option:selected").index() + 1
                          : e(this).find("option").length - 1
                      )
                      .text()
          ...
          .parents("body")
          .on("click", function (i) {
            var o = t._core.$element.find(
              "." + t._core.options.select["class"]
            );
            o.length &&
              (o.is(i.target) ||
                0 !== o.has(i.target).length ||
                o
                  .find("select")
                  .each(function () {
            ...
            e(this)
              ...
              .each(function () {
                e(this)
                  .parent()
                  .find(".value")
                  .text(e(this).prop("selectedIndex", 0).val()),
                  e(this).parent().find(".option").removeClass("selected");
              });
          });
      }),
      ...
      (t.prototype.close = function () {
        navigator.userAgent.match(/(iPod|iPhone|iPad)/) ||
          (e(this).hasClass("show") && e(this).removeClass("show"));
      }),
      (t.prototype.open = function () {
        navigator.userAgent.match(/(iPod|iPhone|iPad)/) ||
          e(this).hasClass("show") ||
  ...
  (function (e) {
    ...
    (t.Defaults = {
      ...
      (t.prototype.create = function () {
        var t = this;
        t._core.$element
          .find(t._core.options.datepicker.applyTo)
          .each(function () {
            e(this)
              .attr({
                type: navigator.userAgent.match(/(iPod|iPhone|iPad)/)
                  ? "date"
                  : "text",
                "data-type": "date",
              })
          ...
          .parent()
          .find("." + t._core.options.datepicker["class"])
          .each(function () {
      ...
      (t.prototype.watch = function () {
        ...
        t._core.$element
          ...
          .on(
            "click",
            "." + t._core.options.datepicker["class"] + "_next",
            function () {
              var i = e(this).parents(
                "." + t._core.options.datepicker["class"]
              );
          ...
          .on(
            "click",
            "." + t._core.options.datepicker["class"] + "_prev",
            function () {
              var i = e(this).parents(
                "." + t._core.options.datepicker["class"]
              );
          ...
          .on("keydown", function (i) {
            (9 == i.keyCode || (i.shiftKey && 9 == i.keyCode)) &&
              e(this).on("blur", t.blur);
          })
          .parents("body")
          .on("mousedown", function (e) {
            var i = t._core.$element
              .find("." + t._core.options.datepicker["class"])
              .parent();
            i.length &&
              (i.is(e.target) || 0 !== i.has(e.target).length
                ? i.find("input").off("blur", t.blur)
                : i.find("input").on("blur", t.blur).trigger("blur"));
          }),
      ...
      (t.prototype.close = function () {
        navigator.userAgent.match(/(iPod|iPhone|iPad)/) ||
          (e(this).hasClass("open") && e(this).removeClass("open"));
      }),
      (t.prototype.open = function () {
        navigator.userAgent.match(/(iPod|iPhone|iPad)/) ||
      ...
      (t.prototype.pick = function (t, i) {
        ...
        o.data("pickedDate", i.day.addClass("dp-selected").data("date")),
          ...
          o
            ...
            .find("input")
            .val(
              (o.data("pickedDate").getMonth() + 1 < 10
                ? "0" + (o.data("pickedDate").getMonth() + 1)
                : o.data("pickedDate").getMonth() + 1) +
                "." +
                (o.data("pickedDate").getDate() < 10
                  ? "0" + o.data("pickedDate").getDate()
                  : o.data("pickedDate").getDate()) +
                "." +
                o.data("pickedDate").getFullYear()
            );
      }),
      (t.prototype.update = function (t, i) {
        var o = e(this),
        ...
        s.append(
          ...
          s.append(
            e("<div/>", {
              ...
              text:
                i.months[o.data("date").getMonth()] +
                " " +
                o.data("date").getFullYear(),
            })
          );
      ...
      (t.prototype.refresh = function (t, i) {
        for (
          var o = e(this), s = e("<table/>"), n = e("<tr/>"), a = 0;
          a < i.days.length;
          a++
        )
          n.append(
        ...
        for (
          var r = o.data("date"),
            l = o.data("pickedDate"),
            c = new Date(r.getFullYear(), r.getMonth() + 1, 0).getDate(),
            d = new Date(r.getFullYear(), r.getMonth(), 0).getDate(),
            p = new Date(r.getFullYear(), r.getMonth(), 1).getDay(),
            f = 1,
            a = 0;
          7 > a;
          a++
          ...
          for (var h = 0; 7 > h; h++) {
            ...
            if (
              ...
              break;
            1 > m - p
              ? (g.text(d + (m - p)).addClass("dp-offset"),
                (u = new Date(r.getFullYear(), r.getMonth() - 1, d + (m - p))))
              : c + p >= m
              ? (g.text(m - p),
                (u = new Date(r.getFullYear(), r.getMonth(), m - p)))
              : (g.text(f).addClass("dp-offset"),
                (u = new Date(r.getFullYear(), r.getMonth() + 1, f++))),
              u.valueOf() == y.valueOf() && g.addClass("dp-today"),
              l && u.valueOf() == l.valueOf() && g.addClass("dp-selected"),
    ...
    (this._handlers = { "mfIcon.change": this.change }),
      ...
      (t.prototype.create = function () {
        ...
        t._core.$element.find(t._core.options.icon.applyTo).each(function () {
          var i = e(this);
          i.append(
            e("<span/>", { class: t._core.options.icon["class"] }).append(
              e("<span/>")
            )
          );
        });
      ...
      (t.prototype.watch = function () {
        var t = this;
        t._core.$element
          .find("." + t._core.options.icon["class"])
          .on(t._handlers);
        for (var i in t._core.options.icon.states) {
          ...
          for (var s in t._core.options.icon.states[i])
            for (var n in t._core.options.icon.states[i][s])
              o.on(
                t._core.options.icon.states[i][s][n],
                { state: s },
                function (i) {
                  e(this)
                    .find("." + t._core.options.icon["class"])
                    .attr("class", i.data.state.replace(".", " "));
                }
              );
        }
      });
  ...
  (function (e) {
    ...
    (this._handlers = { "mfIcon.change": this.change }),
      ...
      (t.prototype.create = function () {
        var t = this;
        t._core.$element
          .find(t._core.options.placeholder.applyTo)
          .each(function () {
            var i = e(this);
            i.append(
              e("<span/>", {
                class: t._core.options.placeholder["class"],
                text: i.find("[placeholder]").attr("placeholder")
                  ? i.find("[placeholder]").attr("placeholder")
                  : i.find("[data-placeholder]").attr("data-placeholder"),
              })
            )
              .find("[placeholder]")
      ...
      (t.prototype.watch = function () {
        var t = this;
        t._core.$element
          .find("." + t._core.options.placeholder["class"])
          .on("click", function () {
        ...
        for (var i in t._core.options.icon.states) {
          ...
          for (var s in t._core.options.placeholder.states[i])
            for (var n in t._core.options.placeholder.states[i][s])
              o.on(
                t._core.options.placeholder.states[i][s][n],
                { state: s },
                function (i) {
                  e(this)
                    .find("." + t._core.options.placeholder["class"])
  ...
  (function (e) {
    ...
    (t.Defaults = { progress: { applyTo: ".mfInfo", class: "mfProgress" } }),
      (t.prototype.initialize = function () {
      ...
      (t.prototype.create = function () {
        var t = this;
        t._core.$element
          .find(t._core.options.progress.applyTo)
          .each(function () {
            var i = e(this);
            i.addClass(t._core.options.progress["class"])
              .wrapInner(e("<span/>", { class: "cnt" }))
              .append(e("<span/>", { class: "loader" }))
              .append(e("<span/>", { class: "msg" }));
          });
      }),
      (t.prototype.watch = function () {
        var t = this;
        t._core.$element
          .on("mf.process", function () {
            e(this)
              .find("." + t._core.options.progress["class"])
              .removeClass("hide")
              .addClass("sending")
              .find(".msg")
              .text("Loading...");
